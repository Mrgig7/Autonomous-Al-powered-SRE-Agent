...
class PagerDutyNotifier(BaseNotifier):
    ...
    def _build_event(self, payload: NotificationPayload, action: str) -> dict[str, Any]:
        ...
        if payload.error_snippet:
            custom_details["error_snippet"] = self.truncate_text(
                payload.error_snippet, 1000
            )
        ...
        event = {
            ...
            "payload": {
                ...
                "group": payload.repository.split("/")[0] if payload.repository and "/" in payload.repository else "default",
